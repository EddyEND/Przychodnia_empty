jQuery(document).ready(function ($) {
    ...
    _CaptionTransitions["TEST"] = { $Duration: 1200, $Zoom: 3, $Rotate: -0.3, $FlyDirection: 1, $Easing: { $Left: $JssorEasing$.$EaseInCubic, $Rotate: $JssorEasing$.$EaseInBack }, $ScaleHorizontal: 0.6, $Opacity: 2 }
    ...
    var options = {
        ...
        $SlideWidth: jQuery(window).width(),                //[Optional] Width of every slide in pixels, default value is width of 'slides' container
    ...
    jQuery("#slider1_container, #slider1_container > div, #slider1_container > div > div > div, #slider1_container > div > div > div > div").css("width", "100%");
    jQuery("#slider1_container > div > div > div, .slidecontent").css("height", "400px");

    jQuery(".slidecontent").css("width", "1200px");
    jQuery(".slidecontent").css("min-width", "1200px");
    jQuery(".slidecontent").css("margin", "0px auto");
    

    jQuery("#slider1_container > div > div > div > div img[u='image']").css("width", "100%").css("height", "400px");
    jQuery("#slider1_container > div > div > div > div img[u='image']").css("width", "100%").css("height", "400px");
